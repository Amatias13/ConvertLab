...
export default function ImageTool({ showToast }) {
      ...
      {!img ? (
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
          <div onClick={() => fileRef.current.click()}
            ...
            onDrop={onDrop}
            style={{ border: `1.5px dashed ${drag ? 'var(--accent)' : 'var(--border2)'}`, borderRadius: 16, padding: '3rem 5rem', textAlign: 'center', cursor: 'pointer', color: drag ? 'var(--text2)' : 'var(--text3)', background: drag ? 'rgba(124,109,255,0.04)' : 'transparent', transition: 'all 0.2s' }}>
