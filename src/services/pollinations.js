...
export async function callAI(systemPrompt, userText, model) {
  ...
  const attempts = hasSK
    ? [
        () => callWithSK(systemPrompt, userText, model),
        () => callAnonymous(systemPrompt, userText, model),
        () => callAnonymousGET(systemPrompt, userText, model),
      ]
    : [
        () => callAnonymous(systemPrompt, userText, model),
        () => callAnonymousGET(systemPrompt, userText, model),
        () => callAnonymousGET(systemPrompt, userText, model === 'openai' ? 'mistral' : 'openai'),
      ]
