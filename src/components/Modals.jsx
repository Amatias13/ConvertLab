    ...
    <div className="modal-backdrop" onClick={() => setModal(null)}>
      <div className="modal-box" style={{ width: "100%", maxWidth: 460 }} onClick={(e) => e.stopPropagation()}>
        <div style={{ padding: "1rem 1.25rem", borderBottom: "1px solid var(--border)", display: "flex", alignItems: "center" }}>
          ...
          <button onClick={() => setModal(null)} style={{ marginLeft: "auto", background: "none", border: "none", cursor: "pointer", color: "var(--text3)", fontSize: 18 }}>
            ✕
          </button>
        </div>
        ...
        {sent ? (
          ...
          <div style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              {types.map((t) => (
                <button
                  ...
                  style={{
                    ...
                    background: type === t.id ? "rgba(124,109,255,0.08)" : "transparent",
                    cursor: "pointer",
                    fontFamily: "var(--sans)",
            ...
            <textarea value={text} onChange={(e) => setText(e.target.value)} rows={5} placeholder="Describe your idea, bug, or experience..." style={{ width: "100%" }} disabled={loading} />
        ...
        <div style={{ padding: "2rem", textAlign: "center", display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8, width: "100%" }}>
            {[
              ...
              <a
                key={opt.amount}
                href="https://buymeacoffee.com/andrematiasdev"
                target="_blank"
                rel="noreferrer"
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = opt.color + "0f";
          ...
          <button onClick={() => setModal(null)} style={{ fontSize: 12, color: "var(--text3)", background: "none", border: "none", cursor: "pointer", fontFamily: "var(--sans)" }}>
            Maybe later
          </button>
        </div>
      </div>
      ...
      {toasts.map((t) => (
        <div
          ...
          style={{
            ...
            background: "var(--bg3)",
            border: `1px solid ${colors[t.type] || "var(--border2)"}44`,
            borderLeft: `3px solid ${colors[t.type] || "var(--accent)"}`,
            borderRadius: 10,
            fontSize: 12.5,
            color: "var(--text)",
